GTCEuStartupEvents.registry('gtceu:machine', event => {
    ...
    event.create('laser_welder', 'simple')
        .tiers(GTValues.LV, GTValues.MV, GTValues.HV, GTValues.EV, GTValues.IV, GTValues.LuV, GTValues.ZPM, GTValues.UV, GTValues.UHV, GTValues.UEV, GTValues.UIV)
        .definition((tier, builder) =>
            builder
    ...
    event.create('squeezer', 'simple')
        .tiers(GTValues.ULV, GTValues.LV, GTValues.MV, GTValues.HV, GTValues.EV, GTValues.IV, GTValues.LuV, GTValues.ZPM, GTValues.UV, GTValues.UHV, GTValues.UEV, GTValues.UIV)
        .definition((tier, builder) =>
            builder
    ...
    event.create('chemical_reactor', 'simple')
        ...
        .definition((tier, builder) =>
            builder
                ...
                .workableTieredHullModel('gtceu:block/machines/chemical_reactor')
        )
    event.create('packer', 'simple')
        .tiers(GTValues.ULV)
        .definition((tier, builder) =>
            builder
    ...
    event.create('gas_collector', 'simple')
        .tiers(GTValues.ULV)
        .definition((tier, builder) =>
            builder
    ...
    //Generators
    event.create('steam_turbine', 'generator')
        .tiers(GTValues.ULV)
        .definition((tier, builder) =>
            builder
    ...
    event.create('combustion_generator', 'generator')
        .tiers(GTValues.ULV)
        .definition((tier, builder) =>
            builder
    ...
    event.create('mana_infuser', 'simple')
        ...
        event.create('botanical_purification_chamber', 'simple')
        .tiers(GTValues.LV, GTValues.MV, GTValues.HV, GTValues.EV, GTValues.IV, GTValues.LuV, GTValues.ZPM, GTValues.UV, GTValues.UHV, GTValues.UEV, GTValues.UIV)
        .definition((tier, builder) =>
            builder
                .langValue(GTValues.VLVH[tier] + " Botanical Purification Chamber")
                .recipeType('botanical_purification_chamber')
                .workableTieredHullModel('gtceu:block/machines/botanical_purification_chamber')
        ) 

        event.create('runic_assembler', 'simple')
        .tiers(GTValues.MV, GTValues.HV, GTValues.EV, GTValues.IV, GTValues.LuV, GTValues.ZPM, GTValues.UV, GTValues.UHV, GTValues.UEV, GTValues.UIV)
        .definition((tier, builder) =>
            builder
