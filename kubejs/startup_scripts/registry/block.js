StartupEvents.registry('block', event => {
    ...
    ["manasteel_livingrock", "metal", "pickaxe", "Manasteel Plated Livingrock Casing"],
    ["manasteel_livingwood", "metal", "pickaxe", "Manasteel Plated Livingwood Casing"],
    ["terrasteel_livingwood", "metal", "pickaxe", "Terrasteel Plated Livingwood Casing"],

    ["acacia_magnalium", "metal", "pickaxe", "Magnalium-Plated Acacia Planks"],
    ["spruce_zinc", "metal", "pickaxe", "Zinc-Plated Spruce Planks"],

    ["voidbound", "metal", "pickaxe", "Void-Stabilizing Casing"]
]
    //Huge Thanks to Puff
    ...
    event.create('manasteel_firebox', 'gtceu:active')
        .firebox(
