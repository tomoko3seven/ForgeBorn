...
event.shaped(Item.of('4x gtceu:cobblestone_ingot'), [
    '   ',
    ' C ',
    ' F '
], {
...
event.shaped(Item.of('kubejs:cloth'), [
    ' SN',
    'SSS',
    ' S '
], {
...
event.shaped(Item.of('gtceu:cobblestone_file'), [
    ' C ',
    ' C ',
    ' S '
], {
...
event.shaped(Item.of('kubejs:contradiction_stone_dust'), [
    '   ',
    ' S ',
    ' B '
], {
...
event.shaped(Item.of('kubejs:wool_clutch', 4), [
    '   ',
    ' S ',
    ' B '
], {
    ...
    event.shaped('kubejs:tanned_leather', [
    ' S ',
    'SLS',
    ' S '
], {
...
event.recipes.farmersdelight.cutting(
        ...
        [ // results
            'kubejs:sulfur_chunk',
            Item.of('kubejs:sulfur_chunk')
                .withChance(0.1)
        ],
        // '' // sound
	);

    event.recipes.gtceu.macerator('gtceu:macerator/sulfur')
...
event.shaped('gtceu:ulv_wiremill', [
    ...
    event.shaped('gtceu:ulv_chemical_reactor', [
    'GTG',
    'CMC',
    'VHV'
], {
    ...
    event.shaped('gtceu:mana_pulse_infuser', [
    'RMR',
    'CHC',
    'VOV'
], {
...
event.recipes.gtceu.alloy_smelter('gtceu:ditchbulb_resin_ingot')
...
event.replaceInput(
    ...
    event.recipes.gtceu.mana_pulse_infuser('gtceu:earth_tablet')
    ...
    .EUt(GTValues.VA[GTValues.ULV])
    .duration(20*25)
    event.recipes.gtceu.mana_pulse_infuser('gtceu:fire_tablet')
    ...
    .EUt(GTValues.VA[GTValues.ULV])
    .duration(20*25)
    event.recipes.gtceu.mana_pulse_infuser('gtceu:water_tablet')
    ...
    .EUt(GTValues.VA[GTValues.ULV])
    .duration(20*25)
    event.recipes.gtceu.mana_pulse_infuser('gtceu:wind_tablet')
    ...
    //Mana-Pulse Alloys
    event.recipes.gtceu.mana_pulse_infuser('gtceu:cloggrumsteel')
    .itemInputs('kubejs:earth_tablet', '32x gtceu:steel_dust', '32x gtceu:cloggrum_dust')
    ...
    event.recipes.gtceu.mana_pulse_infuser('legendarysurvivaloverhaul:sun_fern_seeds')
    ...
    event.recipes.gtceu.mana_pulse_infuser('legendarysurvivaloverhaul:ice_fern_seeds')
    .itemInputs('kubejs:wind_tablet')
    .itemInputs('16x minecraft:wheat_seeds')
...
event.recipes.gtceu.extraterrestial_agglomeration('kubejs:test')
    .itemInputs('kubejs:wind_tablet')
    .itemInputs('16x minecraft:wheat_seeds')
    .itemInputs('32x minecraft:snow_block')
    .inputFluids('kubejs:dense_mana 100')
...
event.recipes.gtceu.assembler('cobblestone_bricks')
    ...
    naturesaura.altar('kubejs:mana_core', 'minecraft:amethyst_shard', 500, 50)
        ...
        naturesaura.tree_ritual('kubejs:advanced_mana_core', ['botania:mana_powder', 'botania:mana_powder', 'botania:mana_powder', 'botania:mana_powder', 'kubejs:mana_core',
        'kubejs:mana_core', 'kubejs:mana_core', 'kubejs:mana_core'
    ], 'botania:pure_daisy', 300)
})