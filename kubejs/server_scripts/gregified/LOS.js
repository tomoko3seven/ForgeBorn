ServerEvents.recipes((event) => {
    ...
    event.shaped(
        Item.of('legendarysurvivaloverhaul:heater'),
        [
            'SPS',
            'PHP',
            'PBP',
    ...
    event.shaped(
        Item.of('legendarysurvivaloverhaul:cooler'),
        [
            'PSP',
            'PHP',
            'PRP',
    ...
    event.shaped(
        Item.of('legendarysurvivaloverhaul:canteen'),
        [
            'SLR',
            'L L',
            ' LS',
    ...
    event.shaped(
        Item.of('legendarysurvivaloverhaul:large_canteen'),
        [
            'SLR',
            'L L',
            ' LS',
