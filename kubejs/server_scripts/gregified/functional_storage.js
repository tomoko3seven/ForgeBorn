ServerEvents.recipes((event) => {
    ...
    event.remove({
        output: 'functionalstorage:framed_simple_compacting_drawer',
    });
    ...
    event.recipes.gtceu
        .assembler('kubejs:configuration_tool')
        .itemInputs('#forge:plates/polyethylene', '#gtceu:circuits/ulv')
    ...
    event.shaped(
        Item.of('functionalstorage:iron_downgrade'),
        [
            ' C ',
            'DTD',
            ' C ',
    ...
    event.shaped(
        Item.of('functionalstorage:void_upgrade'),
        [
            ' O ',
            'OSO',
            ' O ',
    ...
    event.shaped(
        Item.of('2x functionalstorage:ender_drawer'),
        [
            'OOO',
            'GPG',
            'OCO',
