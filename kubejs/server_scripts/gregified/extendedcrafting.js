...
event.recipes.gtceu.bender("black_iron_slate")
...
event.recipes.gtceu.autoclave("extendedcrafting:black_iron_ingot")
...
event.recipes.gtceu.mixer('extendedcrafting:luminessence')
.itemInputs('2x minecraft:glowstone_dust', 'minecraft:redstone', 'gtceu:opal_dust', 'minecraft:gunpowder')
...
event.recipes.gtceu.assembler('extendedcrafting:basic_catalyst')
.itemInputs('4x extendedcrafting:basic_component', 'extendedcrafting:black_iron_slate')
