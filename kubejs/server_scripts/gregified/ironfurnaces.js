ServerEvents.recipes(event => {
    ...
    furnaceCrafting('ironfurnaces:upgrade_iron', 'ironfurnaces:iron_furnace', 'gtceu:iron_plate', 'gtceu:double_iron_plate', 'minecraft:furnace')
    furnaceCrafting('ironfurnaces:upgrade_gold', 'ironfurnaces:gold_furnace', 'gtceu:gold_plate', 'gtceu:double_gold_plate', 'ironfurnaces:iron_furnace')
    furnaceCrafting('ironfurnaces:upgrade_diamond', 'ironfurnaces:diamond_furnace', 'gtceu:steel_plate', 'gtceu:double_steel_plate', 'ironfurnaces:gold_furnace')
    ...
    augment('minecraft:blast_furnace','gtceu:iron_gear','ironfurnaces:augment_blasting')
    augment('minecraft:smoker','gtceu:iron_gear','ironfurnaces:augment_smoking')
    augment('minecraft:sugar','gtceu:steel_gear','ironfurnaces:augment_speed')
    augment('gtceu:coke_gem','gtceu:creosote_bucket','ironfurnaces:augment_fuel')
