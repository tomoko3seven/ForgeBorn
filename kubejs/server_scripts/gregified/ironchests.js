ServerEvents.recipes(event => {
    ...
    //GregTech
    event.recipes.gtceu.assembler('iron_chest_iron')
    .itemInputs('4x #forge:plates/iron', '4x #forge:double_plates/iron', '#forge:chests')
    .itemOutputs('ironchest:iron_chest')
    .duration(60)
    .EUt(GTValues.VA[GTValues.LV]);
    event.recipes.gtceu.assembler('ironchest:gold_chest')
    .itemInputs('4x #forge:plates/gold', '4x #forge:double_plates/gold', 'ironchest:iron_chest')
    .itemOutputs('ironchest:gold_chest')
    .duration(60)
    .EUt(GTValues.VA[GTValues.LV]);
    event.recipes.gtceu.assembler('ironchest:diamond_chest')
