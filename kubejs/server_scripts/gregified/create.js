// Original Code from Cosmic Frontiers (Ghostipedia) - Modified by sqvizers for ForgeBorn
let demolish = (itemName) => {
...
demolish('create:brass_ingot');
demolish('create:brass_nugget');
demolish('create:copper_nugget');
demolish('create:zinc_ingot');
demolish('create:zinc_nugget');

demolish('create:propeller');
//create connected removals
demolish(/create_connected:copycat_(.*)/);
demolish('create_connected:control_chip');
demolish('create_connected:incomplete_control_chip');
demolish('create_connected:fan_seething_catalyst');
demolish('create_connected:fan_ending_catalyst_dragon_head');
demolish('create_connected:fan_ending_catalyst__dragons_breath');
demolish('create_connected:fan_freezing_catalyst');
demolish('create_connected:fan_enriched_catalyst');
demolish('create_connected:fluid_vessel');
...
ServerEvents.recipes((event) => {
    ...
    event.remove({
        id: 'create:cutting/compat/blue_skies/stripped_cherry_log',
    });
    event.remove({ id: 'create:cutting/compat/biomesoplenty/cherry_log' });
    event.remove({
        id: 'create:cutting/compat/forbidden_arcanus/stripped_cherrywood_log',
    });
    event.remove({
        id: 'create:cutting/compat/forbidden_arcanus/stripped_mysterywood',
    });
    event.remove({
    ...
    event.remove({
        id: 'create:cutting/compat/forbidden_arcanus/mysterywood_log',
    });
    ...
    event.remove({
        id: 'create:cutting/compat/forbidden_arcanus/stripped_cherrywood',
    });
    event.remove({
    ...
    event.remove({
        id: 'create:cutting/compat/forbidden_arcanus/cherrywood_log',
    });
    event.remove({
        id: 'create:cutting/compat/forbidden_arcanus/stripped_mysterywood_log',
    });
    ...
    event.recipes.gtceu
        .assembler('create:large_cogwheel')
    ...
    //Copper Casing
    event.recipes.gtceu
        .assembler('create:copper_casing')
    ...
    //Train Casing
    event.recipes.gtceu
        .assembler('create:railway_casing')
    ...
    //Encased Chain Drive
    event.recipes.gtceu
        .assembler('create:encased_chain_drive')
    ...
    event.recipes.gtceu
        .assembler('create:adjustable_chain_gearshift')
    ...
    event.recipes.gtceu
        .assembler('create:electron_tube')
        .itemInputs(
            '1x gtceu:glass_tube',
            '1x create:polished_rose_quartz',
            '1x gtceu:iron_plate'
        )
    ...
    event.recipes.gtceu
        .assembler('create:belt_connector')
    ...
    event.recipes.gtceu
        .assembler('create:mechanical_press')
        .itemInputs(
    ...
    event.recipes.gtceu
        .assembler('create:whisk')
        .itemInputs('gtceu:iron_plate', '3x gtceu:iron_ring')
        .circuit(4)
    ...
    event.recipes.gtceu
        .assembler('create:mechanical_mixer')
        .itemInputs(
            'create:whisk',
            '2x create:andesite_casing',
            'create:cogwheel',
    ...
    event.recipes.gtceu
        .assembler('create:weighted_ejector')
        .itemInputs(
            '2x create:cogwheel',
            'create:depot',
            'gtceu:andesite_alloy_spring',
    ...
    event.recipes.gtceu
        .assembler('create:fluid_tank')
        .itemInputs(
            'gtceu:bronze_drum',
            '4x gtceu:copper_plate',
            '2x minecraft:glass_pane',
            '2x gtceu:bronze_plate'
        )
    ...
    event.recipes.gtceu
        .assembler('create:hose_pulley')
        .itemInputs(
            'ulvcovm:ulv_electric_pump',
            '5x gtceu:copper_plate',
    ...
    event.recipes.gtceu
        .assembler('create:item_drain')
        .itemInputs(
            '2x gtceu:bronze_plate',
            'minecraft:iron_bars',
            '3x create:copper_casing'
        )
    ...
    event.recipes.gtceu
        .assembler('create:portable_fluid_interface')
        .itemInputs(
            'ulvcovm:ulv_electric_pump',
            'create:copper_casing',
            'create:chute'
    ...
    event.recipes.gtceu
        .assembler('create:mechanical_piston')
        .itemInputs(
            '3x gtceu:treated_wood_plate',
            'ulvcovm:ulv_electric_piston',
    ...
    event.recipes.gtceu
        .assembler('create:piston_extension_pole')
    ...
    event.recipes.gtceu
        .assembler('create:gantry_carriage')
        .itemInputs(
    ...
    event.recipes.gtceu
        .assembler('create:gantry_shaft')
        .itemInputs(
            '4x gtceu:andesite_alloy_plate',
            '3x gtceu:red_alloy_foil',
            '2x gtceu:andesite_alloy_rod'
        )
    ...
    event.recipes.gtceu
        .assembler('create:mechanical_bearing')
        .itemInputs(
            '3x gtceu:treated_wood_plate',
            '2x create:andesite_casing',
            '2x create:cogwheel',
    ...
    event.recipes.gtceu
        .assembler('create:clockwork_bearing')
        .itemInputs(
            '3x gtceu:treated_wood_plate',
    ...
    event.recipes.gtceu
        .assembler('create:rope_pulley')
        .itemInputs(
            '3x gtceu:andesite_alloy_plate',
            '2x create:andesite_casing',
            '2x create:shaft',
            'ulvcovm:ulv_electric_motor',
            '#forge:rope'
    ...
    event.recipes.gtceu
        .assembler('create:elevator_pulley')
        .itemInputs(
            '3x gtceu:andesite_alloy_plate',
            '2x create:brass_casing',
            '2x create:shaft',
    ...
    event.recipes.gtceu
        .assembler('create:cart_assembler')
        .itemInputs(
            '2x gtceu:andesite_alloy_plate',
            '2x create:andesite_casing',
    ...
    event.recipes.gtceu
        .assembler('create:linear_chassis')
        .itemInputs(
            '4x gtceu:andesite_alloy_plate',
            '3x #minecraft:logs',
    ...
    event.recipes.gtceu
        .assembler('create:radial_chassis')
        .itemInputs(
            '4x gtceu:andesite_alloy_plate',
            '3x #minecraft:logs',
            '2x gtceu:treated_wood_plate'
    ...
    event.recipes.gtceu
        .assembler('create:sticker')
        .itemInputs(
            '2x gtceu:andesite_alloy_plate',
            '2x gtceu:stone_plate',
            '#forge:slimeballs',
    ...
    event.recipes.gtceu
        .assembler('create:mechanical_drill')
        .itemInputs(
            '2x create:andesite_casing',
            '2x gtceu:andesite_alloy_plate',
            'gtceu:steel_drill_head',
            'gtceu:andesite_alloy_gear',
            'ulvcovm:ulv_electric_motor'
        )
    ...
    event.recipes.gtceu
        .assembler('create:mechanical_saw')
        .itemInputs(
            '2x create:andesite_casing',
            '2x gtceu:andesite_alloy_plate',
            'gtceu:wrought_iron_buzz_saw_blade',
            'gtceu:andesite_alloy_gear',
            'ulvcovm:ulv_electric_motor'
        )
    ...
    event.recipes.gtceu
        .assembler('create:portable_storage_interface')
        .itemInputs(
    ...
    event.recipes.gtceu
        .assembler('create:mechanical_harvester')
        .itemInputs(
            'create:andesite_casing',
    ...
    //Mechanical Plough
    event.recipes.gtceu
        .assembler('create:mechanical_plough')
        .itemInputs(
            'create:andesite_casing',
    ...
    //Mechanical Roller
    event.recipes.gtceu
        .assembler('create:mechanical_roller')
        .itemInputs(
            'create:andesite_casing',
    ...
    event.recipes.gtceu
        .assembler('create:mechanical_crafter')
        .itemInputs(
            '4x gtceu:brass_plate',
            '2x create:brass_casing',
    ...
    event.remove({ output: 'railways:smokestack_coalburner' });
    event.shaped(
    ...
    event.recipes.gtceu
        .assembler('create:rotation_speed_controller')
        .itemInputs(
    ...
    //Precision Mechanism
    event.recipes.gtceu
        .assembler('create:precision_mechanism')
        .itemInputs(
            'gtceu:brass_plate',
        ...
        .EUt(8);
    event.recipes.gtceu
        .assembler('create:mechanical_arm')
        .itemInputs(
            '2x create:brass_casing',
            'gtceu:aluminium_rod',
            'create:precision_mechanism',
    ...
    event.recipes.gtceu
        .assembler('create:track_station')
    ...
    event.recipes.gtceu
        .assembler('create:track_signal')
        .itemInputs(
            '3x create:railway_casing',
    ...
    event.recipes.gtceu
        .assembler('create:track_observer')
        .itemInputs(
            '3x create:railway_casing',
            '#gtceu:circuits/lv',
            'minecraft:observer',
    ...
    event.recipes.gtceu
        .assembler('create:item_vault')
        .itemInputs(
            '4x gtceu:bronze_plate',
            '4x gtceu:bronze_rod',
            'gtceu:bronze_crate'
        )
    ...
    event.recipes.gtceu
        .assembler('create:andesite_funnel')
    ...
    event.recipes.gtceu
        .assembler('create:andesite_tunnel')
    ...
    event.recipes.gtceu
        .assembler('create:brass_tunnel')
        .itemInputs(
            '5x gtceu:brass_plate',
            '2x gtceu:rubber_foil',
            'create:electron_tube'
        )
    ...
    //Smart Observer
    event.recipes.gtceu
        .assembler('create:content_observer')
        .itemInputs(
            'create:brass_casing',
            'minecraft:observer',
            'create:electron_tube'
    ...
    //Threshold Switch
    event.recipes.gtceu
        .assembler('create:stockpile_switch')
        .itemInputs(
            'create:brass_casing',
    ...
    //Redstone Link
    event.recipes.gtceu
        .assembler('create:redstone_link')
    ...
    event.recipes.gtceu
        .assembler('create:mechanical_pump')
        .itemInputs(
            'create:fluid_pipe',
            'ulvcovm:ulv_electric_pump',
            'create:cogwheel'
    ...
    //Diving Helm
    event.remove({
        output: Item.of('create:copper_diving_helmet', '{Damage:0}'),
    });
    event.shaped(
        Item.of('create:copper_diving_helmet', '{Damage:0}'),
        [
            'CCC',
            'CGC',
            '   ',
    ...
    event.recipes.gtceu
        .alloy_smelter('create:rose_quartz')
    ...
    event.recipes.gtceu
        .compressor('create:rose_quartz_block')
    ...
    event.remove({
        id: 'create_connected:crafting/kinetics/empty_fan_catalyst_from_seething',
    });
    event.remove({
        id: 'create_connected:crafting/kinetics/empty_fan_catalyst_from_ending_dragon_head',
    });
    event.remove({
        id: 'create_connected:crafting/kinetics/empty_fan_catalyst_from_freezing',
    });
    event.remove({
        id: 'create_connected:crafting/kinetics/empty_fan_catalyst_from_ending_dragons_breath',
    });
    event.remove({
        id: 'create_connected:crafting/kinetics/empty_fan_catalyst_from_enriched',
    });
    event.remove({
        id: 'create_connected:crafting/kinetics/empty_fan_catalyst_from_withering',
    });
    event.remove({
        id: 'create_connected:crafting/kinetics/empty_fan_catalyst_from_sanding',
    });
    ...
    event.recipes.gtceu
        .assembler('create_connected:item_silo')
        .itemInputs(
