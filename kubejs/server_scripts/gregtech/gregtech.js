ServerEvents.recipes(event => {
  ...
  event.remove({ output: 'gtceu:lp_steam_extractor' })
    ...
    //High-pressure
    event.recipes.gtceu.assembler('gtceu:assembler/industrial_steam_casing')
    ...
    event.shaped('kubejs:wrought_iron_firebox', [
        'PRP',
        'RFR',
        'PRP'
      ], {
  ...
  event.remove({ output: 'gtceu:resin_circuit_board' })
    event.shaped('2x gtceu:resin_circuit_board', [
      ' R ',
      ' C ',
      ' R '
    ], {
  ...
  event.shaped('6x gtceu:resin_circuit_board', [
      'RRR',
      'CCC',
      'RRR'
    ], {
  ...
  event.shaped('kubejs:solid_wrought_iron_casing', [
      'HPS',
      'PCP',
      'SPF'
    ], {
    ...
    event.recipes.gtceu.assembler('gtceu:assembler/resin_printed_circuit_board')
...
event.recipes.gtceu.assembler('gtceu:resistor')
...
event.recipes.gtceu.assembler('gtceu:resistor_better')
...
event.smelting('gtceu:vacuum_tube', 'kubejs:not_vacuum_tube')
    ...
    event.recipes.gtceu.assembler('gtceu:assembler/basic_electronic_circuit')
    .itemInputs('6x gtceu:red_alloy_single_cable', '2x gtceu:vacuum_tube', '2x gtceu:resistor', '2x gtceu:steel_plate', 'gtceu:resin_printed_circuit_board')
...
event.shaped('kubejs:not_vacuum_tube', [
"ABA",
"CDC",
" C "
], {
...
event.recipes.gtceu.assembler("ulv_casink")
.itemInputs("8x gtceu:wrought_iron_plate")
.circuit(6)
.itemOutputs("gtceu:ulv_machine_casing")
.EUt(16)
.duration(25)
event.shaped('gtceu:ulv_steam_turbine', [
"PIP",
"RHR",
"MCM"
], {
...
event.shaped('gtceu:ulv_combustion_generator', [
"PIP",
"MHM",
"GCG"
], {
...
event.recipes.gtceu.sawmill("planks")
...
.EUt(10)
.duration(20*4.5)
event.recipes.gtceu.sawmill("treated_planks")
...
.EUt(10)
.duration(20*4.5)
event.recipes.gtceu.sawmill("archwood_planks")
...
event.recipes.gtceu.assembler("poly_wafer_diode")
...
.EUt(30)
.duration(400)
event.recipes.gtceu.assembler("poly_arsenide_diode")
.itemInputs("4x gtceu:fine_annealed_manasteel_wire")
...
.EUt(30)
.duration(400)
event.recipes.gtceu.assembler("glass_wafer_diode")
.itemInputs("4x gtceu:fine_annealed_manasteel_wire")
.itemInputs("gtceu:silicon_wafer")
.itemOutputs("2x gtceu:diode")
.inputFluids("forestry:glass 144")
.EUt(30)
.duration(400)
event.recipes.gtceu.assembler("glass_arsenide_diode")
.itemInputs("4x gtceu:fine_annealed_manasteel_wire")
.itemInputs('#forge:small_dusts/gallium_arsenide')
...
.duration(400)
//MV
event.recipes.gtceu.assembler("phenolic_cdb")
